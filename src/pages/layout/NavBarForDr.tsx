...
import { c } from "node_modules/framer-motion/dist/types.d-Cjd591yU";
  ...
  const menuItems = [
    { icon: LayoutDashboard, label: "الصفحة الرئيسية", link: "/driverNavBar/driverDashBoard" },
    { icon: CarFront, label: "اقتراحات العملاء", link: "/driverNavBar/driverTips" },
    { icon: CarFront, label: "الارباح", link: "/driverNavBar/driverEarnings" },
    { icon: CarFront, label: "الصفحة الشخصية", link: "/driverNavBar/driverProfile" },
  ];
